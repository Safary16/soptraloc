...
class ContainerListSerializer(serializers.ModelSerializer):
    ...
    retorno_destino_cd_nombre = serializers.CharField(source='retorno_destino_cd.nombre', read_only=True, allow_null=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'retorno_destino_tipo', 'retorno_destino_cd', 'retorno_destino_cd_nombre',
