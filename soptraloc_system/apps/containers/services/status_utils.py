...
CANONICAL_STATUSES: Dict[str, str] = {
    ...
    "DESCARGADO_CD": "DESCARGADO_CD",
    "EN_SECUENCIA": "EN_SECUENCIA",
    "ASIGNADO": "ASIGNADO",
    "EN_RUTA": "EN_RUTA",
    "ARRIBADO": "ARRIBADO",
    "DISPONIBLE_DEVOLUCION": "DISPONIBLE_DEVOLUCION",
    "EN_RUTA_DEVOLUCION": "EN_RUTA_DEVOLUCION",
...
STATUS_ALIASES: Dict[str, str] = {
    ...
    "DESCARGADO CD": "DESCARGADO_CD",
    "DESCARGADO_CD": "DESCARGADO_CD",
    "DISPONIBLE DEVOLUCION": "DISPONIBLE_DEVOLUCION",
    "DISPONIBLE_DEVOLUCION": "DISPONIBLE_DEVOLUCION",
    "EN RUTA DEVOLUCION": "EN_RUTA_DEVOLUCION",
    "EN_RUTA_DEVOLUCION": "EN_RUTA_DEVOLUCION",
    "TRG": "TRG",
    "FINALIZADO": "FINALIZADO",
    "LIBERADO": "LIBERADO",
